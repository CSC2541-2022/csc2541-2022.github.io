    ...
    <div className="container">
      <Head>
        ...
        <Page>
          <h2>Logistics</h2>
          <h5>Prerequisites</h5>
          <p>The course prerequisites include a strong background in probabilities, statistics, and Bayesian networks
            (such as factorization, d-separation, colliders, and Markov properties).
            Familiarity with linear algebra and latent variable modeling is useful but not required.</p>
          <h5>Grading</h5>
          <p>Your grade in this course will be composed of the following evaluations:</p>
          <ul>
            <li><b>15%</b>: Problem Set (completed individually)</li>
            <li><b>15%</b>: Paper Summary Assignment (completed individually)</li>
            <li><b>15%</b>: Paper Presentations (completed in groups)</li>
            <li><b>&nbsp;&nbsp;5%</b>: Project Proposal (completed in project groups)</li>
